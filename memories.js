/* ============================================
   ...
   --------------------------------------------
   Edit these entries to personalize the site!
   - date:    YYYY-MM-DD (the day this memory unlocks)
   - title:   Short heading shown on the card
   - text:    Your message / memory description
...
const MEMORIES = [
  {
    ...
    text: "This was the day I met the person who would come to mean so much to me, and I still remember that the day was not good for you, I was not the best you could have hoped for, but somehow you still gave me a chance.",
    image: 'images/1_The_First.jpeg'
  },
  {
    date: '2026-04-27',
